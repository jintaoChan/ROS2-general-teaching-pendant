...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("moveit_config", package_name="moveit_config").to_moveit_configs()
    ...
    ld.add_action(
        ...
        arguments=[
                ...
                "--param-file", str(moveit_config.package_path / "config/ros2_controllers.yaml")],
        )
    )
